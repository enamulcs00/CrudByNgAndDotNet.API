...
namespace CrudByNgAndDotNet.API.Data
{
    public class AuthDbContext : IdentityDbContext<RegisterRequestDto>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            {
                Id = adminUserId,
                UserName = "admin@CrudByNgAndDotNet.com",
                Email = "admin@CrudByNgAndDotNet.com",
                NormalizedEmail = "admin@CrudByNgAndDotNet.com".ToUpper(),
                NormalizedUserName = "admin@CrudByNgAndDotNet.com".ToUpper()
            };
